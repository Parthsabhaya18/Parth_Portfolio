  ...
  return (
    <section id="about" className=" bg-gray-900 py-10 md:py-20 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-14">
        ...
        >
          {/* Image Section */}
          <motion.div className="relative lg:w-2/5" variants={image}>
          ...
          {/* Content Section */}
          <motion.div className="lg:w-3/5" variants={container}>
            <motion.h2
            ...
            <motion.p
              ...
              variants={item}
            >
              I'm a passionate web developer focused on crafting modern,
              responsive, and user-friendly web applications. My core skills
              include <span className="text-yellow-400">HTML</span>,{" "}
              ...
              <span className="text-yellow-400">Material UI</span>. I also work
              confidently with <span className="text-yellow-400">Firebase</span>{" "}
              for real-time features and backend integration. Additionally, I
              have a basic understanding of backend technologies like{" "}
              <span className="text-yellow-400">Node.js</span>,{" "}
              <span className="text-yellow-400">Express</span>, and{" "}
              <span className="text-yellow-400">MongoDB</span>. I'm committed to
              continuous learning and writing clean, efficient code.
            </motion.p>
            ...
            >
              ...
              >
                <Link
                  ...
                  smooth={true}
                  duration={500}
                  offset={-60} // adjust for fixed navbar height if needed
                  className="px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600
                   text-gray-900 font-semibold rounded-lg transition-all duration-300 cursor-pointer 
                   inline-block"
                >
                  Hire Me
                </Link>
